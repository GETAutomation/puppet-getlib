# = Define: getlib::install_packages
#
...
#
# [*template*]
#   String. Optional. Default: 'stdfu/install_packages.erb'
#   The template to use to generate the script that installs the packages
#
# [*scrips_dir*]
#   String. Optional. Default: '/root/stdfu_install_packages'
...
#
# - Minimal setup
# getlib::install_packages { 'build_tools':
#   packages           => 'build-essential vim git-core curl bison',
# }
#
define getlib::install_packages (
  $packages,
  $template         = 'getlib/install_packages.erb',
  $scripts_dir      = '/tmp/get_install_packages',
  $autorun          = true,
  $refreshonly      = true,
  $timeout          = '600',
  $ensure           = 'present' ) {
